...
const Barra = ({ children }) => {
    ...
    return (
        <div className={`barra__lateral ${isOpen ? 'barra__lateral_abierta' : ''}`} title='Menu'>
            ...
            <div title='Lista de Alumnos' className={`boton ${isActive('/alumnosresidentesasign') ? 'activo' : ''}`} onClick={() => navigateTo('/alumnosresidentesasign')}>
